			        ...
			        ?>
					   ...
					   <tr>
							...
							<td style="color: #fd6503;" class="editme" id="sun<?php echo $value['Listing']['id']; ?>" data-field="sun"  data-target="#exampleModal" data-id="<?php echo $value['Listing']['id']; ?>" listval="<?php echo $value['Listing']['sun']; ?>"><?php echo $value['Listing']['sun']; ?></td>
                             <td>
								  <a href="<?php echo $this->webroot; ?>listing-images/<?php echo $value['Listing']['id']; ?>"" id="search" style="font-weight: bold;" class="btn btn-primary btn-sm" onclick=" window.location='<?php echo $this->webroot; ?>listing-detail/srch:'+document.getElementById('searchre').value; ">
